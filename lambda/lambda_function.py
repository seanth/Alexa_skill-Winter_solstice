    ...
    def handle(self, handler_input):
        ...
        theDirective = PlayDirective(
            ...
            audio_item=AudioItem(
                stream=Stream(expected_previous_token=None,token=stream_url,url=stream_url,offset_in_milliseconds=0)
            )
        )
        ...
        return (
            handler_input.response_builder
                .speak(speech_output)
                .add_directive(theDirective)
                .set_card(ui.StandardCard(card_title, card_text, ui.Image(
...
#    def handle(self, handler_input):
#        # type: (HandlerInput) -> Response
#        speech_output = "Paused the stream."
#        theDirective = StopDirective()
#
#        return (
#            handler_input.response_builder
#                .speak(speech_output)
